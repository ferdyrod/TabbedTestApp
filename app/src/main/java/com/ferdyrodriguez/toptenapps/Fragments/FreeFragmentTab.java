 ...
 */
public class FreeFragmentTab extends Fragment {

    public static final String TAG = FreeFragmentTab.class.getSimpleName();
    ...
    private void populateRV(View view) {
        ...
        Call<AppleResponse> call = itunesService.getFreeAppData();
        call.enqueue(new Callback<AppleResponse>() {
            ...
            public void onResponse(Call<AppleResponse> call, Response<AppleResponse> response) {
                if(response.isSuccessful()) {
                    ...
                    Log.d(TAG, "onResponse: Free Apps" + response.body().getFeed().getEntry());
